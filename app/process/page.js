  ...
  return (
    <div className="w-full flex-auto">
      ...
      <section className="pt-8 pb-12   max-sm:pb-8">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="mb-24 flex max-lg:flex-col max-lg:items-center lg:gap-6 max-w-[1344px] mx-auto">
            <div>
                ...
                <div className="pt-10 group-first:pt-0">
                  ...
                  <div className="space-y-6 text-base text-neutral-600 mb-12">
                    ...
                    <p>
                      ...
                      progress of the project. They act as a buffer between the
                      client’s incessant nagging and the development team who
                      are hard at work scouring open source projects for code to
                      re-purpose.
                    </p>
                    <p>
                      Our account managers are trained to only reply to client
                      emails after 9pm, several days after the initial email.
                      This reinforces the general aura that we are very busy and
          ...
          <div className="flex max-lg:flex-col max-lg:items-center lg:gap-6 max-w-[1344px] mx-auto">
